...
#include "WKWidgetHUD.generated.h"

/**
 * 
 */
UCLASS()
class BLACKWK_API UWKWidgetHUD : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable)
	void SetMaxHulu(float MaxHulu);

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable)
	void SetCurrentHulu(float CurrentHulu);

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable)
	void SetHuluPercentage(float HuluPercentage);

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable)
	void SetHuluRegenRate(float HuluRegenRate);
